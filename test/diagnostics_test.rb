...
class DiagnosticsTest < Minitest::Test
  def test_cross_validation
    ...
    # convert to days
    df_p["horizon"] = df_p["horizon"].cast(Polars::Int64) / 1e9.to_i / 86400
  ...
  def test_cross_validation_cutoffs
    ...
    assert_times ["2013-02-15 00:00:00 UTC"], df_cv2["cutoff"].head(1)
    assert_times ["2014-02-15 00:00:00 UTC"], df_cv2["cutoff"].tail(1)
  end
